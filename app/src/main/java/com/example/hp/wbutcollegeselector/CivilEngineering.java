...
class CivilEngineering {
    ...
    public CivilEngineering(String openingRank, String closingRank) {
    ...
    public CivilEngineering(String openingRank, String closingRank, String totalseat, String seatAvailable) {
        this.openingRank = openingRank;
        this.closingRank = closingRank;
        this.totalseat = totalseat;
