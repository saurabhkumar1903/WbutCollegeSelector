...
class ElectronicsAndCommunicationEngineering {
    private String openingRank;
    private String closingRank;
    private String totalseat;
    private String seatAvailable;

    public ElectronicsAndCommunicationEngineering(String openingRank, String closingRank) {
        this.openingRank = openingRank;
        this.closingRank = closingRank;
    }

    public ElectronicsAndCommunicationEngineering() {
        this.openingRank = "0";
        this.closingRank = "0";
        this.totalseat = "5";
    ...
    public ElectronicsAndCommunicationEngineering(String openingRank, String closingRank, String totalseat, String seatAvailable) {
        this.openingRank = openingRank;
        this.closingRank = closingRank;
        this.totalseat = totalseat;
