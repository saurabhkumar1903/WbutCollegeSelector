...
class ElectricalEngineering {
    ...
    public ElectricalEngineering(String openingRank, String closingRank) {
    ...
    public ElectricalEngineering(String openingRank, String closingRank, String totalseat, String seatAvailable) {
        this.openingRank = openingRank;
        this.closingRank = closingRank;
        this.totalseat = totalseat;
