...
class ComputerScienceEngineering {
    ...
    public ComputerScienceEngineering(String openingRank, String closingRank, String totalseat, String seatAvailable) {
        this.openingRank = openingRank;
        this.closingRank = closingRank;
        this.totalseat = totalseat;
